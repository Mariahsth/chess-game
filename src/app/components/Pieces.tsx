  ...
  const pieces = [
    {
      ...
      movement:
        "Can jump up to 3 squares per turn-Can jump to any direction (vertical, horizontal, or diagonal)",
      capture:
        "Captures other pieces by jumping above them-Can NOT jump to squares that are already occupied",
    },
    {
      title: "Designer",
      imageTitle: "designer",
    ...
    },
    {
      ...
      movement:
        "Can move one square per turn-Can move to any direction (vertical, horizontal, or diagonal)",
      capture: "Captures other pieces by moving on top of them-",
    },
  ];
  return (
          ...
          <div className={styles.piece_container} key={index}>
            ...
            <div className={styles.piece_text_container}>
              <div className={styles.movement_container}>
                <img
                  src={`/images/${piece.imageTitle}-moves.png`}
                  alt={`${piece.title} Movement`}
                  className={styles.movement_image}
                />
              ...
              <div className={styles.movement_container}>
                <img
                  src={`/images/${piece.imageTitle}-capture.png`}
                  alt={`${piece.title} Capture`}
                  className={styles.movement_image}
                />
